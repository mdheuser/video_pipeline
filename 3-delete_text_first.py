...
def has_text_first_pass(image_path, min_length=1, confidence_threshold=75):
    """Detects if an image contains any word-like sequence (3+ letters)."""
    try:
        data = pytesseract.image_to_data(image_path, config='--psm 11 --oem 3', output_type=pytesseract.Output.DICT)
...
destination_directory = "/Users/mdh/Documents/two-minute-porn-2025/two_passes/first_pass"
